...
export default function DeliveryDetailPage() {
    const { arriveAtLocation } = useDriverappFlow();
                ...
                <div className="bg-white dark:bg-[#2c2e33] rounded-3xl p-6 shadow-sm border border-slate-100 dark:border-slate-800 space-y-6">
                    ...
                    <div>
                        ...
                        <p className="text-sm font-medium dark:text-slate-300 leading-relaxed">
                            Jl. Raya Industri No. 100, <br /> Cikarang Selatan, Bekasi, <br /> Jawa Barat 17530
                        </p>
                    </div>
                    ...
                    <div className="aspect-video rounded-2xl overflow-hidden border border-slate-100 dark:border-slate-800 relative">
                        <img src="https://images.unsplash.com/photo-1526772662000-3f88f10c05fe?q=80&w=1974&auto=format&fit=crop" alt="Map" className="w-full h-full object-cover opacity-80"/>
                    </div>
                </div>

                <div className="mt-auto pt-8 space-y-4 pb-8">
                    <DriverappButton onClick={() => alert('Maps')} text="BUKA GOOGLE MAPS" icon="map" variant="outline" />
